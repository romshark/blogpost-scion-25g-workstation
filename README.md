...
It's an innovative inter-[AS](https://en.wikipedia.org/wiki/Autonomous_system_(Internet))
routing architecture designed to address BGP's fundamental flaws and security
vulnerabilities.

Maybe at some point in the future the Internet will run SCION, although a more likely
...
The delivery of the Phanteks case was delayed, and no updated or approximate delivery
date was available at the time, so I had to start assembling the system without the case.
